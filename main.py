...
class MainLoop(MainLoopBase):
    ...
    def initNetworks(self):
        net = tf.compat.v1.make_template('scn', self.network)
        ...
        sigmas = tf.compat.v1.get_variable('sigmas', [self.num_landmarks], initializer=tf.constant_initializer(self.heatmap_sigma))
        ...
        self.optimizer = tf.compat.v1.train.MomentumOptimizer(learning_rate=self.learning_rate, momentum=0.99, use_nesterov=True).minimize(self.loss)
